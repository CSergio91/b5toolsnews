...
const translations: Record<LanguageCode, Translations> = {
    es: {
        landing: {
            ...
            hero_desc: "Plataforma Tecnológica de anotación para Beisbol Five. Gestiona torneos, Clubes, estadísticas y comparte resultados en tiempo real con una interfaz intuitiva y fácil de usar.",
    ...
    en: {
        landing: {
            ...
            hero_desc: "Technological scoring platform for Beisbol Five. Manage tournaments, Clubs, statistics, and share real-time results with an intuitive and easy-to-use interface.",
    ...
    pt: {
        landing: {
            ...
            hero_desc: "Plataforma tecnológica de pontuação para Beisbol Five. Gerencie torneios, clubes, estatísticas e compartilhe resultados em tempo real com uma interface intuitiva e fácil de usar.",
    ...
    fr: {
        landing: {
            ...
            hero_desc: "Plateforme technologique de notation pour le Beisbol Five. Gérez tournois, clubs, statistiques et partagez les résultats en temps réel avec une interface intuitive et facile à utiliser.",
    ...
    de: {
        landing: {
            ...
            hero_desc: "Technologische Scoring-Plattform für Beisbol Five. Verwalten Sie Turniere, Vereine, Statistiken und teilen Sie Ergebnisse in Echtzeit mit einer intuitiven und benutzerfreundlichen Oberfläche.",
