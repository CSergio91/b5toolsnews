...
export const LandingPage: React.FC = () => {
    ...
    return (
        <div className="h-[100dvh] w-full bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-slate-900 via-purple-950 to-black text-white selection:bg-purple-500 selection:text-white flex flex-col relative overflow-hidden">
            ...
            {/* Navbar - reduced padding for mobile */}
            <nav className="relative z-20 w-full p-2 md:p-6 flex items-center justify-between shrink-0">
            ...
            {/* Main Content - reduced gap/padding for mobile, using justify-between to distribute space */}
            <main className="flex-1 relative z-10 flex flex-col xl:flex-row items-center justify-between md:justify-center p-2 md:p-6 gap-2 md:gap-12 max-w-7xl mx-auto w-full overflow-hidden">

                {/* Hero Section - Visible on all devices, scaled for mobile */}
                {/* Hero Section - Visible on desktop/tablet, hidden on mobile to save space */}
                <div className="flex flex-col flex-1 text-center xl:text-left space-y-2 md:space-y-6 max-w-2xl justify-center z-20 xl:mb-0 mb-2 h-auto shrink-0 md:shrink-1">
                    <div className="hidden md:inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-[10px] md:text-xs font-medium text-purple-300 mb-0 md:mb-2 mx-auto xl:mx-0">
                    ...
                    <h1 className="hidden md:block text-2xl md:text-5xl lg:text-7xl font-black tracking-tight leading-tight">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 pt-1 md:pt-4 justify-center xl:justify-start">
                        <button
                            onClick={() => navigate('/anotaciongratisbeisbol5')}
                            className="group relative px-6 py-3 md:px-8 md:py-4 bg-white text-black font-bold rounded-xl hover:bg-gray-100 transition-all active:scale-95 shadow-[0_0_20px_rgba(255,255,255,0.3)] flex items-center justify-center gap-2 text-sm md:text-base"
                        >
                ...
                {/* 3D Auth Card Container - Adjusted height for mobile/tablet */}
                {/* 3D Auth Card Container - Further reduced height for mobile/tablet */}
                <div className="w-full max-w-sm md:max-w-md perspective-[2000px] h-[400px] md:h-[650px] flex items-center justify-center shrink-0 z-30">
                    ...
                    <div className={`relative w-full h-full transition-transform duration-700 transform-style-3d ${!isLogin ? 'rotate-y-180' : ''}`}>
                        ...
                        <div className="absolute inset-0 backface-hidden">
                            <div className="h-full bg-slate-900/40 backdrop-blur-xl border border-white/10 p-5 md:p-8 rounded-3xl shadow-2xl flex flex-col overflow-hidden relative">
                                <div className="absolute inset-0 bg-gradient-to-br from-purple-500/10 to-transparent pointer-events-none"></div>

                                <div className="relative z-10 flex-1 flex flex-col justify-center">
                                    <h2 className="text-xl md:text-3xl font-bold mb-1 md:mb-2">{t('landing.login_welcome')}</h2>
                                    <p className="text-white/40 text-[10px] md:text-sm mb-2 md:mb-8">{t('landing.login_subtitle')}</p>
                                    ...
                                    {isForgot ? (
                                        ...
                                        <>
                                            <button
                                                ...
                                                className="w-full py-2.5 md:py-3 bg-white text-black font-bold rounded-xl hover:bg-gray-100 transition-colors flex items-center justify-center gap-3 mb-4 md:mb-6 text-sm md:text-base"
                                            >
                                            ...
                                            <div className="relative mb-2 md:mb-6">
                                                ...
                                                <div className="relative flex justify-center text-[10px] md:text-xs uppercase"><span className="bg-[#0f0e1a] px-2 text-white/30">{t('landing.or_email')}</span></div>
                                            </div>

                                            <form onSubmit={handleLogin} className="space-y-3 md:space-y-4">
                                                <input
                                                    type="email" placeholder={t('landing.email')} value={loginEmail} onChange={e => setLoginEmail(e.target.value)}
                                                    className="w-full bg-black/20 border border-white/10 rounded-xl px-4 py-2.5 md:py-3 text-white text-sm focus:border-purple-500 focus:bg-black/40 transition-all outline-none" required
                                                />
                                                <div className="relative">
                                                    <input
                                                        ...
                                                        className="w-full bg-black/20 border border-white/10 rounded-xl px-4 py-2.5 md:py-3 text-white text-sm focus:border-purple-500 focus:bg-black/40 transition-all outline-none pr-10" required
                                                    />
                                                    <button
                                                        type="button"
                                                ...
                                                {error && <div className="text-red-300 text-xs bg-red-500/10 p-2 rounded border border-red-500/20">{error}</div>}
                                                <button type="submit" disabled={loading} className="w-full py-2.5 md:py-3 bg-purple-600 hover:bg-purple-500 text-white font-bold rounded-xl shadow-lg shadow-purple-900/40 active:scale-95 transition-all text-sm md:text-base">
                        ...
                        <div className="absolute inset-0 backface-hidden rotate-y-180">
                            <div className="h-full bg-slate-900/40 backdrop-blur-xl border border-white/10 p-4 md:p-8 rounded-3xl shadow-2xl flex flex-col overflow-hidden relative">
                                ...
                                <div className="relative z-10 flex-1">
                                    <h2 className="text-xl md:text-3xl font-bold mb-1 md:mb-2">{t('landing.register_title')}</h2>
                                    <p className="text-white/40 text-[10px] md:text-sm mb-2 md:mb-6">{t('landing.register_subtitle')}</p>
                                    ...
                                    <form onSubmit={handleRegister} className="space-y-2 md:space-y-3">
                                        ...
                                        <div className="grid grid-cols-2 gap-2">
                                            <input
                                                ...
                                                className="bg-black/20 border border-white/10 rounded-xl px-2 py-1.5 md:px-3 md:py-2 text-white text-[10px] md:text-sm focus:border-purple-500 outline-none" required
                                            />
                                            <input
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-black/20 border border-white/10 rounded-xl px-2 py-1.5 md:px-3 md:py-2 text-white text-[10px] md:text-sm focus:border-purple-500 outline-none" required
                                        />
                                        ...
                                        <div className="grid grid-cols-2 gap-2">
                                            <div className="relative">
                                                <input
                                                    ...
                                                    className="w-full bg-black/20 border border-white/10 rounded-xl px-2 py-1.5 md:px-3 md:py-2 text-white text-[10px] md:text-sm focus:border-purple-500 outline-none pr-8" required
                                                />
                                            ...
                                            <div className="relative">
                                                <input
                                                    ...
                                                    className={`w-full bg-black/20 border ${regConfirmPassword && regPassword !== regConfirmPassword ? 'border-red-500/50' : 'border-white/10'} rounded-xl px-2 py-1.5 md:px-3 md:py-2 text-white text-[10px] md:text-sm outline-none pr-8`} required
                                                />
                                            </div>
                                        </div>
                                        ...
                                        <div className="grid grid-cols-2 gap-2">
                                            <input
                                                ...
                                                className="bg-black/20 border border-white/10 rounded-xl px-2 py-1.5 md:px-3 md:py-2 text-white text-[10px] md:text-sm focus:border-purple-500 outline-none"
                                            />
                                            <label className="flex items-center justify-center gap-2 px-2 py-1.5 md:py-2 rounded-xl border border-dashed border-white/20 bg-white/5 cursor-pointer hover:bg-white/10">
                                        ...
                                        <div className="grid grid-cols-2 gap-2">
                                            <input
                                                ...
                                                className="bg-black/20 border border-white/10 rounded-xl px-2 py-1.5 md:px-3 md:py-2 text-white text-[10px] md:text-sm focus:border-purple-500 outline-none" required
                                            />
                                            <label className="flex items-center gap-2 px-2 py-1.5 md:py-2 rounded-xl border border-white/10 bg-black/20 cursor-pointer hover:bg-black/30">
                                        ...
                                        <button type="submit" disabled={loading} className="w-full py-2 md:py-2.5 bg-indigo-600 hover:bg-indigo-500 text-white text-xs md:text-sm font-bold rounded-xl shadow-lg shadow-indigo-900/40 active:scale-95 transition-all mt-1 md:mt-2">
                                            {loading ? t('landing.loading') : t('landing.register_btn')}
                                        </button>
                                    </form>

                                    <div className="mt-2 md:mt-4 pt-2 md:pt-4 text-center border-t border-white/10">
            ...
            <footer className="p-2 md:p-6 text-center text-white/20 text-[10px] md:text-xs relative z-10 shrink-0">
