...
export const SubscriptionModal: React.FC<SubscriptionModalProps> = ({ isOpen, onClose }) => {
    ...
    const handleUpdatePlan = async (tier: 'basic' | 'pro' | 'ultra') => {
        ...
        if (user) {
            ...
            // Dispatch custom event to notify other components (simple state bus)
            ...
            <div className="w-full max-w-5xl bg-[#0f0e1a] border border-white/10 rounded-3xl shadow-2xl overflow-hidden flex flex-col relative my-auto">
                ...
                <div className="p-6 md:p-8 overflow-y-auto custom-scrollbar">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 max-w-6xl mx-auto">
                        ...
                        {/* Basic Plan */}
                        <div className="relative group p-6 rounded-2xl bg-white/[0.02] border border-white/10 hover:bg-white/[0.04] transition-all flex flex-col">
                            <div className="mb-4">
                        ...
                        <div className="relative p-6 rounded-2xl bg-gradient-to-b from-purple-900/20 to-indigo-900/20 border border-purple-500/50 shadow-2xl flex flex-col transform md:-translate-y-4 md:hover:-translate-y-5 transition-transform duration-300">
                        ...
                        {/* Ultra Plan */}
                        <div className="relative group p-6 rounded-2xl bg-white/[0.02] border border-white/10 hover:bg-white/[0.04] hover:border-yellow-500/30 transition-all flex flex-col">
                            <div className="mb-4">
                            ...
                            <button
                                onClick={() => handleUpdatePlan('ultra')}
