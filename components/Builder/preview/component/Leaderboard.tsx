...
const Leaderboard: React.FC = () => {
  return (
    <div id="leaderboard-section" className="scroll-mt-24 col-span-1 md:col-span-2 lg:col-span-4 xl:col-span-5 bg-gradient-to-r from-white via-gray-50 to-white dark:from-card-dark dark:via-[#151225] dark:to-card-dark border border-gray-200 dark:border-gray-700/50 rounded-2xl shadow-lg p-5 relative overflow-hidden">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center mb-4 z-10 relative">
        ...
        <a href="#" className="text-xs text-primary hover:text-primary/80 flex items-center mt-2 sm:mt-0 transition-colors">
          View Full Standings <span className="material-icons-round text-sm ml-1">arrow_forward</span>
        </a>
      </div>
